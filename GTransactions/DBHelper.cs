...
namespace VTPServer.Models
{
    public class DBHelper
    {
        ...
        public DataTable GetDataTable(string strSQL, CommandType pCommandType = CommandType.Text, params SqlParameter[] Parameters)
        {
            var sqlCommand = new SqlCommand(strSQL);
        ...
        public object ExecuteScalar(SqlCommand sqlCommand)
        {
            ...
            try
            {
                ...
                var resultData = sqlCommand.ExecuteScalar();
